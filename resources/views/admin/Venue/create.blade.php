                    ...
                    <div id="pane-1" class="bs-stepper-pane" role="tabpanel" aria-labelledby="trigger-1">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="total_floor" type="number" min="1" class="form-control @error('total_floor') is-invalid @enderror" value="{{ old('total_floor', 1) }}">
                            ...
                            <div class="col-md-6 form-check">
                                <input name="multi_floor" type="checkbox" id="multi_floor" class="form-check-input" value="1" {{ old('multi_floor') ? 'checked' : '' }}>
                    ...
                    <div id="pane-2" class="bs-stepper-pane" role="tabpanel" aria-labelledby="trigger-2">
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input name="address[city]" type="text" class="form-control @error('address.city') is-invalid @enderror" value="{{ old('address.city') }}">
                                @error('address.city')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">State</label>
                                <input name="address[state]" type="text" class="form-control @error('address.state') is-invalid @enderror" value="{{ old('address.state') }}">
                                @error('address.state')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Pincode</label>
                                <input name="address[pincode]" type="text" class="form-control @error('address.pincode') is-invalid @enderror" value="{{ old('address.pincode') }}">
                                @error('address.pincode')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-12">
                                <label class="form-label">Address</label>
                                <textarea name="address[addr]" class="form-control @error('address.addr') is-invalid @enderror" rows="2">{{ old('address.addr') }}</textarea>
                                @error('address.addr')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-12">
                                <label class="form-label">Google Maps Link</label>
                                <input name="address[google_link]" type="url" class="form-control @error('address.google_link') is-invalid @enderror" value="{{ old('address.google_link') }}">
                    ...
                    <div id="pane-3" class="bs-stepper-pane" role="tabpanel" aria-labelledby="trigger-3">
                        <div class="row">
                            <div class="col-xl-9 mx-auto">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="custom-upload-box p-3">
                                        <div id="coverPreview" class="image-preview mb-3" style="max-width:150px">
                                            <img src="https://placeholder.pics/svg/300x200/EEE/AAA/No%20Cover" alt="Cover Image" class="img-thumbnail" />
                                        </div>
                                ...
                                <div class="custom-upload-box p-3">
                                    <div class="d-flex flex-wrap mb-3" id="previewContainer"></div>
                    ...
                    <div id="pane-4" class="bs-stepper-pane" role="tabpanel" aria-labelledby="trigger-4">
                        <div class="row g-3">
                            ...
                            <div id="timeSlotsContainer" class="col-12">
                                {{-- Existing (old) slots after validation --}}
                                @php $oldSlots = old('timeslots', []); @endphp

                                @foreach($oldSlots as $i => $ts)
                                    <div class="time-slot-card position-relative" data-slot-index="{{ $i }}">
                                        <button type="button" class="remove-btn" title="Remove" onclick="removeTimeSlot(this)"><span class="material-icons-outlined">delete</span></button>
                                        ...
                                        <div class="row g-3 mt-1">
                                            <div class="col-md-3">
                                                ...
                                                <input type="time" name="timeslots[{{ $i }}][start_time]" class="form-control @error('timeslots.'.$i.'.start_time') is-invalid @enderror" value="{{ $ts['start_time'] ?? '' }}">
                                                @error("timeslots.$i.start_time")<div class="invalid-feedback">{{ $message }}</div>@enderror
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label">End Time</label>
                                                <input type="time" name="timeslots[{{ $i }}][end_time]" class="form-control @error('timeslots.'.$i.'.end_time') is-invalid @enderror" value="{{ $ts['end_time'] ?? '' }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Optional plugin hooks (safe if not present)
...
function addTimeSlot() {
    ...
    card.innerHTML = `
      <button type="button" class="remove-btn" title="Remove" onclick="removeTimeSlot(this)">
...
function removeTimeSlot(btn) {
    const card = btn.closest('.time-slot-card');
    card?.remove();
}
</script>
@endsection
