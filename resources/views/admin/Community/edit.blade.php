...
<div class="main-content pt-0">
    <div class="container py-3">
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
            <h4 class="mb-0">Edit Community Member</h4>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.community-members.update', $member) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="img-holder mb-2" id="previewBox">
                                @php
                                    $currentImage = $member->image ? asset('storage/'.$member->image) : 'https://placehold.co/280x280?text=Preview';
                                @endphp
                                <img id="previewImg" src="{{ $currentImage }}" alt="Preview">
                            </div>
                            <input
                            ...
                            <div class="help mt-1">Leave blank to keep the current image.</div>
